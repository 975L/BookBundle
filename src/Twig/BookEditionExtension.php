...
// How an edition names itself on a page. The kind stored is the site's own word ("illustrated_paper"), whose label only the vocabulary knows (see c975L\BookBundle\Contract\BookCustomizationProviderInterface) - a template guessing a translation key off the kind would print the key itself for every edition the bundle does not ship
