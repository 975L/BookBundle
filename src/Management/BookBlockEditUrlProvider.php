...
// Resolves, for UiBundle's front-end "Edit this block" hover button, the EasyAdmin edit URL of the Book, Serie, Strip or Contributor owning a given Block - so the blocks composed at the foot of a display page hover the same pencil as the sections above them (see BookEditUrlExtension for those)
class BookBlockEditUrlProvider implements BlockEditUrlProviderInterface
{
     ...
     */
    private function urlsOf(string $crudControllerFqcn, Book | Contributor | Serie | Strip $owner, array $blockIds): array
    {
        $urls = [];
