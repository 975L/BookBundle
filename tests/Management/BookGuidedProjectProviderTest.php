...
class BookGuidedProjectProviderTest extends TestCase
{
    ...
    public function testGetGuidedProjectsContinuesTheOrderSequence(): void
    {
        ...
        $this->assertSame(
            ['book-contributor-creation', 'book-serie-creation', 'book-category-creation', 'book-creation', 'book-media-move', 'book-composition', 'book-reader', 'book-sorting', 'book-character-creation', 'book-strip-creation', 'book-duplication', 'book-version-publication', 'book-hidden', 'book-trash', 'book-stores', 'book-export'],
            array_column($projects, 'slug')
        );
        $this->assertSame([6005, 6010, 6015, 6020, 6025, 6030, 6033, 6035, 6037, 6040, 6045, 6050, 6055, 6060, 6065, 6070], array_column($projects, 'order'));
    }
    ...
    public function testEveryProjectCarriesTheRoleItsOwnScreensState(): void
    {
        $expected = array_fill_keys([
            ...
            'book-reader', 'book-sorting', 'book-character-creation', 'book-strip-creation', 'book-duplication', 'book-version-publication', 'book-hidden', 'book-trash', 'book-stores',
